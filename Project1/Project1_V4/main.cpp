...
int main(int argc, char** argv) {
    ...
    const string snake = "You landed on a snake and fell to ",//The text for landing on a snake.
    ...
    //Figures out the game lenght
    {
        ...
        if (c==false){//If the number of players does not have an average
            ...
            turns /=100;//Finds the average amount of turns
            switch(numPlys){//Sets the propper a to turns
                case 1:
                    a1 = turns;
                    break;
                case 2:
            ...
            switch(numPlys){//Sets turns to the propper a
                case 1:
                    turns=a1;
                    break;
                case 2:
